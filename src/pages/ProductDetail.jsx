...
const ProductDetail = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center h-[50vh] w-full">
        <span className="loading loading-dots loading-xl text-3xl"></span>
  ...
  if (errors) {
    return (
      <div role="alert" className="alert alert-error max-w-150 mx-auto my-10">
        <svg
  ...
  return (
    <>
      <nav className="p-4 md:px-6 md:pt-3">
        <ol className="flex items-center space-x-1 sm:space-x-1 md:space-x-2 text-xs sm:text-xs md:text-sm overflow-x-auto scrollbar-hide pb-1">
          ...
          <li className="flex items-center whitespace-nowrap">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="h-3 w-3 sm:h-3 sm:w-3 md:h-4 md:w-4 text-gray-400 mx-1 sm:mx-1 md:mx-2 shrink-0"
            >
          ...
          <li className="flex items-center whitespace-nowrap">
            ...
            <span className="text-gray-500 font-medium truncate max-w-30 sm:max-w-none">
              {product.name}
            </span>
          </li>
        </ol>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 xl:gap-16 mb-8 sm:mb-12 md:mb-16 lg:mb-20 px-4 py-0">
        <div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="relative z-10 space-y-2">
              ...
              <AddToCardAndBuyNowBtn product={product} quantity={quantity} />
